                ...
                {tag:'table',attr:{id:'report_tbl',style:'width:auto; font-size:15px'},className:"styled width-80",child:[
                  {tag:'thead',child:[
                    {tag:'tr',child:[
                      ...
                      {tag:'th',attr:{'style':'vertical-align:middle'},child:["Dessins"]},
                      {tag:'th',attr:{'style':'vertical-align:middle'},child:["Emplacement"]},
                      {tag:'th',attr:{'style':'vertical-align:middle'},child:["Type"]},
                      {tag:'th',attr:{'style':'vertical-align:middle; width:65px'},child:["km début"]},
                      {tag:'th',attr:{'style':'vertical-align:middle; width:65px'},child:["km fin"]}
                    ]}
                  ]},
